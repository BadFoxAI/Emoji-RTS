...
function getEmojiForFaction(type, factionKey) {
    ...
    if (!faction || !faction.emojis || !faction.emojis[type]) {
        // isDebugVisible is a global from game-state.js, may not be initialized when this file is first parsed.
    ...
    // If emojiData is an array, pick one randomly; otherwise, use the string directly.
